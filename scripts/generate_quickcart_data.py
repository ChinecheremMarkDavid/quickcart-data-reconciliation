...
def generate(args):
    ...
    for i in range(args.orders):
        if i % 5000 == 0 and i > 0:
            print(f"  ⏳ Generated {i:,}/{args.orders:,} orders...", flush=True)
    ...
    for i, oid in enumerate(order_ids):
        if i % 5000 == 0 and i > 0:
            print(f"  ⏳ Generated payment attempts for {i:,}/{len(order_ids):,} orders...", flush=True)
    ...
    print("⏳ Generating orphan payments...", flush=True)
    ...
    print("⏳ Generating bank settlements...", flush=True)
    ...
    print("⏳ Generating event logs...", flush=True)
